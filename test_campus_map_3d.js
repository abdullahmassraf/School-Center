...
if(!postBudget.touch||!postBudget.profile||postBudget.qualityDpr<1.55||postBudget.pr<1.4||postBudget.dof!==0)throw new Error('mobile sharp-render budget regressed: '+JSON.stringify(postBudget));
...
if(sharpOverview.dof!==0||sharpOverview.uniform!==0||sharpOverview.pr<1.4)throw new Error('mobile overview is not staying sharp: '+JSON.stringify(sharpOverview));
