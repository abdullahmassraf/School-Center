...
await ev(`(()=>{const d=window.__SC_CAMPUS_MAP_3D__.frame.contentWindow.__DAVIS_TWIN_DEBUG__;d.AUTO.on=true;d.interaction.lastInput=performance.now()-4500;return window.__SC_CAMPUS_MAP_3D__.reset()})()`);
await sleep(5000);
